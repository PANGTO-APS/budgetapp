...
var budgetController = (function() {
    ...
    return {
        ...
        calculateBudget: function() {
            // Calculate income and expeneses
            calculateTotal('exp');
            calculateTotal('inc');
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var setEventListeners = function() {
        ...
        document.querySelector(DOM.contrainer).addEventListener('click', ctrlDeleteItem);
    ...
    var ctrlAddItem = function() {
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 4. Clear fields
            UICtrl.clearFields();
            // 5. Calculate and upadate budget
            updateBudget();
